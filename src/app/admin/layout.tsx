...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-blue-50/30 dark:bg-slate-950 flex flex-col md:flex-row">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed md:sticky top-0 left-0 z-60 h-full w-72 bg-white/80 backdrop-blur-xl border-r border-blue-100 dark:border-slate-800 flex flex-col shadow-2xl shadow-blue-900/5 transition-transform duration-300 md:translate-x-0
        ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"}
      `}>
        <div className="p-8 hidden md:block">
          <div className="flex items-center space-x-3">
            <div className="bg-blue-600 text-white w-10 h-10 flex items-center justify-center rounded-xl font-black text-xl shadow-lg shadow-blue-200">
              A
            </div>
            <h2 className="text-xl font-black text-blue-950 dark:text-white tracking-tight uppercase">Admin Panel</h2>
          </div>
        </div>
        ...
        <nav className="flex-1 px-4 py-8 md:py-0 space-y-2 overflow-y-auto">
            ...
            <Link
              ...
              className={`flex items-center space-x-3 p-4 rounded-2xl font-bold transition-all duration-300 ${
                pathname === item.href
                  ...
                  : "text-blue-900/60 dark:text-slate-400 hover:bg-blue-50 dark:hover:bg-slate-900 hover:text-blue-600 dark:hover:text-white"
              }`}
            >
              {item.icon}
          ...
          <div className="pt-6 mt-6 border-t border-blue-50 dark:border-slate-800">
            <Link
              href="/"
              className="flex items-center space-x-3 p-4 text-blue-900/60 dark:text-slate-400 hover:bg-blue-50 dark:hover:bg-slate-900 hover:text-blue-600 dark:hover:text-white rounded-2xl font-bold transition-all"
            >
              <Home size={20} />
        ...
        <div className="p-6 mt-auto border-t border-blue-50 dark:border-slate-800">
          <button
            ...
            className="flex items-center space-x-3 p-4 w-full text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-2xl font-bold transition-all"
          >
            <LogOut size={20} />
